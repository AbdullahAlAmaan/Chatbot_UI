...
const App = () => {
  ...
  if (isChatStarted) {
    return <ChatPage onBackToLanding={handleBackToLanding} />;
  }
  return (
      ...
      <div className="relative">
        ...
        <div className="relative p-5 pb-8">
          ...
          <div className="relative z-10 mt-5 bg-white rounded-lg p-4 shadow-lg outline outline-offset-2 outline-gray-500/10">
            <FAQ />
            <Footer onStartChat={handleStartChat} showContinueConversation={showContinueConversation} /> {/* Pass handler to Footer */}
          </div>
        </div>
      </div>
    </div>
